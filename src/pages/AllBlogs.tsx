...
import { Newspaper, ArrowLeft, Calendar, Clock, Search, ArrowRight, Trash2 } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-12 py-10 md:py-16">
        <header className="mb-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
            <div>
              <h1 className="font-serif text-4xl md:text-6xl font-bold text-primary mb-4 tracking-tight">Journal Archive</h1>
              <p className="text-secondary text-lg font-serif italic max-w-xl">Every story we've ever shared in our kitchen, preserved for your culinary inspiration.</p>
            </div>
            <div className="relative w-full md:w-80">
              ...
              />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 text-stone-300 pointer-events-none" size={18} />
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-10">
          {loading ? (
            ...
            <AnimatePresence mode="popLayout">
              ...
              >
                <Link to={`/blog/all/${blog.id}`} className="flex flex-col h-full">
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-6 border-t border-stone-50 flex items-center justify-between">
                      <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Explore Now</span>
        ...
        {filteredBlogs.length === 0 && (
          <div className="py-32 text-center">
            ...
            <p className="text-stone-400 font-serif text-xl italic">No posts found matching your search.</p>
          </div>
        )}
      </main>
    </motion.div>
