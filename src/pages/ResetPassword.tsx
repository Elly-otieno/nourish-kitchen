    ...
    return (
      <div className="min-h-screen pt-32 px-6 bg-[#faf9f6]">
        <div className="max-w-md mx-auto text-center">
            ...
            <h1 className="font-serif text-3xl text-stone-900 mb-4">Invalid Link</h1>
          ...
          <AnimatePresence mode="wait">
            {!success ? (
              ...
              >
                ...
                <h1 className="font-serif text-4xl text-emerald-950 text-center mb-4">New Password</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-900/40 px-1">New Password</label>
                    <div className="relative group">
                      <Lock className="absolute left-6 top-1/2 -translate-y-1/2 text-stone-300 group-focus-within:text-emerald-600 transition-colors" size={18} />
                      <input 
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-900/40 px-1">Confirm New Password</label>
                    <div className="relative group">
                      <Lock className="absolute left-6 top-1/2 -translate-y-1/2 text-stone-300 group-focus-within:text-emerald-600 transition-colors" size={18} />
                      <input 
                        type={showPassword ? 'text' : 'password'} 
              ...
              >
                ...
                <h2 className="font-serif text-4xl text-emerald-950 mb-6 font-bold leading-tight">Password Updated</h2>
